...
namespace CBA
{
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        public override async Task<ClaimsIdentity> CreateUserIdentityAsync(ApplicationUser user)
        {
            ...
            // Add dynamic user claims with respect to the user's role
    ...
    public static class ExtendedClaimsProvider
    {
        public static IEnumerable<Claim> GetClaims(ApplicationUser user)
        {
            ...
            var roleClaims = user.Role.RoleClaims.Select(c => c.Claim).ToList();
                /*.Where(x => x.ID == user.RoleID)
                .Include(c => c.RoleClaims)
                .Select(c => c.RoleClaims.Where(x => x.Claim.ID == x.ClaimID));*/
